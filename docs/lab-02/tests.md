...
| API-04 | API | BR-46 | Seed run twice, then requesters and categories re-queried | Same row count and same ids — idempotent | `server/tests/lab-02/seed.api.test.ts` | Pending |
